...
export default class Deck extends Component {
  ...
  signIn (event) {
    CreateToken(this.state.signInFormData, [
      ...
      window.localStorage.setItem('token', tokenData.createToken.token)
      window.localStorage.setItem('user', JSON.stringify(tokenData.createToken.user))
      window.localStorage.setItem('role', tokenData.createToken.user.role.type)
          ...
          <Grid.Column width={13}>
            ...
            <div>
              ...
              <List bulleted='bulleted'>
                ...
                <List.Item>
                  You should have <strong>min 1 GB</strong> download/upload every month.
                </List.Item>
                <List.Item>
                  You must do it <strong>on site</strong> for the counting of uploads size.
                </List.Item>
              </List>
            </div>
